 ...
 */
public class CategoryListAdapter extends AbsBaseAdapter<Home.DataEntity.ProductsEntity> {
    public CategoryListAdapter(Context context, List<Home.DataEntity.ProductsEntity> data) {
        super(context, data);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView ==null){
            ...
            convertView = inflater.inflate(R.layout.item_gridview_category,null);
            holder.thumbImage = (ImageView) convertView.findViewById(R.id.iv_gridview_category);
            holder.nameTv = (TextView) convertView.findViewById(R.id.tv_category_name);
            holder.priceTv = (TextView) convertView.findViewById(R.id.tv_category_price);
            holder.discountTv = (TextView) convertView.findViewById(R.id.tv_category_discount);
