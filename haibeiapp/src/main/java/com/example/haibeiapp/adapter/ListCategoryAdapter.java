 ...
 */
public class ListCategoryAdapter extends AbsBaseAdapter<Home.DataEntity.ProductsEntity> {
    public ListCategoryAdapter(Context context, List<Home.DataEntity.ProductsEntity> data) {
        super(context, data);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView ==null){
            ...
            holder.nameTv = (TextView) convertView.findViewById(R.id.tv_listview_category_title);
            holder.priceTv = (TextView) convertView.findViewById(R.id.tv_listview_category_price);
