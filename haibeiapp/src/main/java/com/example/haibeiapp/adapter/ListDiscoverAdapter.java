...
import com.example.haibeiapp.bean.ListDiscover;
 ...
 */
public class ListDiscoverAdapter extends AbsBaseAdapter<Home.DataEntity.ProductsEntity> {
    public ListDiscoverAdapter(Context context, List<Home.DataEntity.ProductsEntity> data) {
        super(context, data);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String thumb = getData().get(0).getImages().get(position).getThumb();
